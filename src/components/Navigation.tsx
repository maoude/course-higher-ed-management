  ...
  return (
    <nav style={{
      ...
      <div className="social-links">
        ...
        <a href="[https://www.youtube.com/@your-channel-id](https://www.youtube.com/@your-channel-id)" target="_blank" rel="noopener noreferrer" aria-label="YouTube"> {/* Replace with your actual YouTube channel URL */}
          <YouTubeIcon />
        </a>
