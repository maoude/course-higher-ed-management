// src/pages/Module2Session1SlidesPage.tsx
import React, { useState, useEffect, useCallback } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { module2Session1Slides, Slide } from '../data/Module2Session1SlideData';

const Module2Session1SlidesPage: React.FC = () => {
  const [currentSlideIndex, setCurrentSlideIndex] = useState(0);
  const navigate = useNavigate();

  const totalSlides = module2Session1Slides.length;
  const currentSlide: Slide | undefined = module2Session1Slides[currentSlideIndex];
...
export default Module2Session1SlidesPage;